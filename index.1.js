...
PIXI.loader
 ...
 function onAssetsLoaded()
 {
    ...
    blockSprites = [];
    blockSprites[0] = new PIXI.extras.TilingSprite(blockTexts[0]);
    blockSprites[0].x = 0;
    blockSprites[0].y = 100;
    blockSprites[0].width = 300;
    blockSprites[0].height = 200;
    ...
    block101.width = 300;
    block101.height = 200;
    block101.anchor.set(0.5);
    block101.animationSpeed = 0.15;
    app.stage.addChild(blockSprites[1]);
    
    //blockTexts[0].position = (-10,0);
    //app.stage.addChild(blockTexts[0]);
